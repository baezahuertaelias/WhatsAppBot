...
def clean_message(message_entity):
    ...
    myString=str(message_entity.body)
    mySubString=myString[myString.find("'")+1:myString.find("queso")]
    return mySubString
...
def command(message_entity):
    ...
    try:
        myString=str(message_entity.body)
        mySubString=myString[myString.find("'")+1:myString.find("queso")]
        command = message(mySubString)#.split(' ', 1)[0]
    except IndexError:
        print("Command error")
...
def predicate(message_entity):
    ...
    try:
        myString=str(message_entity.body)
        rest=myString[myString.find("'")+1:myString.find("queso")]
